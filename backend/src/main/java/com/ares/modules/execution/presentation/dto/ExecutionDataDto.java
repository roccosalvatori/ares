package com.ares.modules.execution.presentation.dto;
...
/**
 * DTO for Execution data.
 * Presentation layer representation - separate from domain.
 */
public class ExecutionDataDto {
    ...
    public String getBloombergLongTicker() { return bloombergLongTicker; }
    public void setBloombergLongTicker(String bloombergLongTicker) { this.bloombergLongTicker = bloombergLongTicker; }
